            ...
            <div className='md:w-10/12 sm:w-11/12 md:h-4/6 sm:h-5/6 border-2 border-emerald-400 rounded-lg overflow-hidden shadow-xl'>
                <div className='md:flex md:justify-between w-full h-full'>
                    <div className='hidden sm:flex md:hidden'>
                        <h1 className='mx-auto mt-3 text-2xl underline decoration-emerald-400'>
                            Login
                        </h1>
                    </div>
                    ...
                    <div className='md:w-6/12 md:h-full sm:h-5/6 sm:w-full'>
                        <div className='hidden md:flex'>
                            <h1 className=' my-10 mx-auto text-3xl underline decoration-emerald-400'>
                                Login
                            </h1>
                        </div>
